...
class LLM_GEN_SM:
    ...
    async def _async_generate(self, few_shot_template, query_example, query_idx):
        ...
        #API_KEY = "sk-vtmOQqxVAi8htM2hpDDf_g"
        ...
        async with httpx.AsyncClient(timeout=10) as client:
            ...
            print(f"[SM_DIS] Discriminative query {query_idx} ")
            ...
            for retry in range(MAX_RETRIES):
                try:
                    ...
                    print(f'[SM_GEN] query {query_idx} RETRYING LLM REQUEST {retry+1}/{MAX_RETRIES}...')
                    print(resp)
                    print(e)
                    time.sleep(10)
    ...
    def select_query_point(self, observed_configs, observed_fvals, candidate_configs, return_raw_preds=False):
        ...
        pred_probs, cost, time_taken = loop.run_until_complete(self._evaluate_candidate_points(observed_configs, observed_fvals, candidate_configs))
